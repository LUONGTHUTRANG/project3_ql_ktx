          ...
          <div className="bg-surface-light dark:bg-surface-dark rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900 dark:text-white">Duyệt đơn đăng ký</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Xem và duyệt đơn đăng ký ở KTX</p>
                </div>
                <span className="material-symbols-outlined text-green-600 ml-auto" style={{ fontSize: '20px' }}>arrow_forward</span>
              </button>
            </div>
          </div>
        </div>
                  ...
                  supportRequests.map((request, index) => (
                    <tr key={request.id || index} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${request.status === 'completed' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' :
