...
import { getAllRegistrations, updateRegistrationStatus, Registration } from '../api_handlers/registrationApi';
...
const RegistrationManagement: React.FC = () => {
    ...
    const fetchRegistrations = async () => {
        ...
        setError(null);
        try {
            const filters: { status?: string; search?: string; registration_type?: string; building_id?: number } = {};
            if (statusFilter) filters.status = statusFilter;
            if (typeFilter) filters.registration_type = typeFilter;
            if (searchQuery) filters.search = searchQuery;
            // For manager, only show registrations from their building
            if (isManager && user?.building_id) {
                filters.building_id = user.building_id;
            }
