...
interface UtilityFeeInvoiceTabProps {
  invoices: InvoiceRow[];
  loading: boolean;
  error: string | null;
  currentPage: number;
...
const UtilityFeeInvoiceTab: React.FC<UtilityFeeInvoiceTabProps> = ({
  invoices,
  loading,
  error,
  currentPage,
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-6 lg:col-span-3">
              <label className="block text-xs font-medium text-text-secondary dark:text-gray-400 mb-2">Trạng thái thanh toán</label>
              <Select
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50/50 dark:bg-gray-800/50 border-b border-border-color dark:border-gray-700">
                  ...
                  <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-text-secondary dark:text-gray-400">Chỉ số</th>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                {invoices.map((row) => (
                  <tr key={row.id} className="group hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-xs italic text-text-secondary dark:text-gray-400">{row.indices}</span>
                    </td>
